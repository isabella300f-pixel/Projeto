// Script para sincronizar dados AGORA - atualiza lib/data.ts imediatamente
...
console.log('🔄 Sincronizando dados da planilha AGORA...\n');
...
// Importar funções de processamento da API route
// (copiando a lógica diretamente aqui)
...
// Funções de normalização (mesmas da API)
...
const mappedData = jsonData.map((row) => {
  ...
  // Mapear todos os campos (mesma lógica da API)
  const data = {
    period: periodNormalized,
    paSemanal: getValue(rowMap, ['pa semanal realizado', 'pa semanal', 'pasemanal', 'premio anual semanal', 'pa realizado', 'pa semanal realizado r$', 'pa semanal r$', 'premio anual semanal realizado']) || 0,
...
console.log('🎉 Arquivo lib/data.ts atualizado! Pronto para apresentação.');
